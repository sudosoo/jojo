              ...
              a:switch (choseMenu){
                case 1 :
                    while (true) {
                        ...
                        System.out.println("----------------------------------------");
                        System.out.print("👩🏻‍🎓은행 중 하나를 선택해 주세요 :");
                        String bankName = "";
                        try {
                            ...
                            System.out.println("❗ [" + sc.nextLine() + "] 잘못된 입력 입니다. 해당 숫자를 입력해  주세요 ❗");
                            break;
                        }
                        while (true) {
                            System.out.println();
                            ...
                            try {
                                ...
                                while (true) {
                                    if (chooseMenu == 1) {
                                        ...
                                        System.out.print("👩🏻‍🎓 검색할 계좌 소유주를 입력해 주세요 :");
                                        ...
                                        System.out.print("👩🏻‍🎓삭제할 계좌 번호를 입력해 주세요 :");
                                ...
                                System.out.println();
                                System.out.println("❗[" + sc.nextLine() + "] 잘못된 입력 입니다. 해당 숫자를 입력 해주세요 ❗");
                            }
                        }
                    }
                    break;
                    case 2:
                        System.out.println();
                        System.out.println("❗️ 이름을 입력해 주세요 ❗️");
                        String equalsName = sc.next();
                        System.out.println("❗️ 계좌번호를 입력해 주세요 (-는 제외) ❗️");
                                    ...
                                    try {
                                        ...
                                        switch (menu) {
                                            case 1:
                                                ...
                                                System.out.println("❗️ 입금 할 금액를 입력해 주세요 ❗️");
                                            ...
                                            case 2:
                                                ...
                                                System.out.println("❗️ 출금 할 금액를 입력해 주세요 ❗️");
